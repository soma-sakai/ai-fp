...
const HeroSection: React.FC = () => {
  return (
    <section className="bg-gradient-to-r from-light to-gray-light py-20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
              AI住宅予算診断で<br />
              <span className="text-primary">理想の家づくり</span>を叶える
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/diagnosis">
                <Button className="px-6 py-3 text-lg">無料で診断を始める</Button>
              </Link>
              <Link href="/fp-consultation">
                <Button variant="outline" className="px-6 py-3 text-lg">FP相談を予約する</Button>
              </Link>
            </div>
          </div>
          ...
          <div className="md:w-1/2">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="bg-gray-light p-4 rounded-lg mb-4">
              ...
              <div className="text-center">
                <Link href="/diagnosis">
                  <Button fullWidth className="py-2">今すぐ診断する</Button>
                </Link>
              </div>
            </div>
          </div>
