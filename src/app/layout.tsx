            ...
            <div className="flex justify-between h-16">
              <div className="flex items-center">
                <Link href="/" className="flex-shrink-0 flex items-center">
                  <span className="text-gray-800 font-bold text-xl">安心予算</span>
                </Link>
              ...
              <div className="flex items-center">
                <Link 
                  href="/diagnosis" 
                  className="ml-3 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-800 hover:bg-gray-900"
                >
                  診断を始める
                </Link>
              </div>
